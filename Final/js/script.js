...
kingStLayer.bindPopup("This is Seattle's currently active train station! Union St station is unfortunately closed forever. However you may explore inside during business hours.")
soccerLayer.bindPopup("You might come here for a soccer or football match! Do not buy food here, it's very expensive!")
pioneerSquareLayer.bindPopup("One of seattles oldest neighborhoods, this is where the city was founded. Check out the old buildings and bars")
smithTowerLayer.bindPopup("Seattle's original skyscraper! Go to the top and have a drink at the bar!")
westlakeParkLayer.bindPopup("Originally a street, this city plaza is a great place to take a breather or wait for a bus. The Seattle hotdog stand is here as well.")
uStationLayer.bindPopup("Take the train to this street car suburb of U-district. Here you'll find the university and other related activies.")
